...
int main()
{
    ...
    std::vector<uint8_t> key128 = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f };
    ...
    std::cout << "\nAES 192" << std::endl;
    std::cout << "Input:\t\t"; printVector(inp);
    std::vector<uint8_t> key192 = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
    ...
    std::cout << "\nAES 256" << std::endl;
    std::cout << "Input:\t\t"; printVector(inp);
    std::vector<uint8_t> key256 = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
